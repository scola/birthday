 ...
 */
public class BirthdayBackupAgent extends BackupAgentHelper {
    /**
     ...
     */
    static final String FILE_HELPER_KEY = "json_file";
    static final String MY_PREFS_BACKUP_KEY = "prefs_xml";
    ...
    public void onCreate() {
        ...
        FileBackupHelper helper = new FileBackupHelper(this, BirthdayLab.FILENAME);
        addHelper(FILE_HELPER_KEY, helper);

        SharedPreferencesBackupHelper prefHelper =
                new SharedPreferencesBackupHelper(this, "BirthdayListActivity");
        addHelper(MY_PREFS_BACKUP_KEY, prefHelper);
    }
    ...
    public void onBackup(ParcelFileDescriptor oldState, BackupDataOutput data,
        ...
        synchronized (BirthdayLab.sDataLock) {
